...
Write-Host "1️⃣ SETTING ENVIRONMENT VARIABLE CORRECTLY" -ForegroundColor Yellow
...
Write-Host "2️⃣ CREATING PRODUCTION .ENV FILE" -ForegroundColor Yellow
...
Write-Host "3️⃣ TESTING PRISMA CONNECTION" -ForegroundColor Yellow
...
Write-Host "4️⃣ LAUNCHING PRISMA STUDIO" -ForegroundColor Yellow
